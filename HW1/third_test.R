...
default_data_generation = function() {
  set.seed(123)
...
#initial value
#x = c(5,4,0,0,2,1) # nearly converged value with step_size=0.01, tol=1e-5, seed(123)

#x = c(1,1,4,5,1,4)

#x = c(2,1,1,-1,1/3,2) # nearly converged value with step_size=0.001, tol=1e-5, seed(123)
# $pi_value
# [1] 0.3594701 0.6405299
# $u
# [1]  0.1986469 -1.0450208
# $sigma
# [1] 0.3514457 0.1986469
# $iter
# [1] 10000
...
result_list = gradient_descent(x,data_points,step_size = 0.01,max_iter =5000,tol = 1e-7, loss_tol=1e-6,report = FALSE)
result_list[2:5]
result_list$loss %>% tail()
result_list$loss %>% plot()

result_list$grad %>% plot()
result_list$grad %>% tail()



#result_list = gradient_descent(x_0,data_points,step_size = 0.01,max_iter =1000,tol = 1e-5,report = FALSE)
loss_function(x_0,data_points)
